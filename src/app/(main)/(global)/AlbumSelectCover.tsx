...
import { albumCoverUpdate, coverFilesFullList$ } from '@/services/legend'
import { ListItemType } from '@/types/list'

const { height: SCREEN_HEIGHT } = Dimensions.get('window')

const AlbumSelectCover = () => {
  ...
  const handleSelect = (item: ListItemType, dismiss: () => void) => {
    if (album) {
      albumCoverUpdate(album, item.icon as string | number)
    }
    dismiss()
  }
...
export default AlbumSelectCover
